          ...
          GetBuilder<NotificationController>(builder: (notificationController) {
            ...
            return notificationList.isEmpty
                ? ItemEmptyPage(
                    ...
                    descriptionOne: 'There are currently no notifications to display.',
                    imagePath: 'asset/server_down.png',
                  )
                : Expanded(
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        return Container(
                          margin:
                              EdgeInsets.only(left: Dimensions.width10, right: Dimensions.width10, bottom: Dimensions.height10),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              //image section
